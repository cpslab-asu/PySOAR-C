...
# from pysoarc.coreAlgorithm.UR import InitializationPhase
from soar.optimizer import InitializationPhase, GlobalPhase, LocalBest, LocalPhase
import pickle
import numpy as np
...
for rep in range(1):
    ...
    print(seed)
    with open(f"/home/local/ASURITE/tkhandai/Research_Work/pysoarc-cleanup/PySOAR-C/demos/pysoarc_max500_rep_50_seed123456.pickle", "rb") as f:
    # with open(f"/home/daittan/RA_Work/pysoar-c/demos/UR_res/UR_max500_rep100_seed{seed}.pickle", "rb") as f:
    ...
    # print(point_history)
    # x,y = _generate_dataset(0, point_history)
    ...
    ax.legend(handles, 
                handle_names)
    plt.savefig(f'pysoarc_samples_seed{seed}.pdf') 
