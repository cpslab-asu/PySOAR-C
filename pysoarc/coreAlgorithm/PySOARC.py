...
from ..utils import CrowdingDist_kd, EIcalc_kd, Fn, pointsInTR
...
def PySOARC(
    ...
    initial_samples, initial_sample_distances = _evaluate_samples(
        ...
        if local_search == "gp_local_search":
            ...
            while (
                ...
                if trs_max_budget - num_points_present > 0:
                    ...
                    local_additional_x, local_additional_y = _evaluate_samples(
